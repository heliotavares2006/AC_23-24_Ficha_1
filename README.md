...
P2 - Resposta:As arquiteturas de Von Neumann e Harvard são dois modelos fundamentais de arquiteturas de computadores, e suas principais diferenças estão na maneira como tratam e armazenam dados e instruções. 
